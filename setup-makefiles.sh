...
mkdir -p ../../../vendor/samsung/epicmtd/overlay/packages/apps/Launcher2/res/layout
(cat << EOF) | sed s/__DEVICE__/$DEVICE/g > ../../../vendor/samsung/epicmtd/overlay/packages/apps/Launcher2/res/layout/all_apps.xml
